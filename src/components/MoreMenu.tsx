    ...
    <AnimatePresence>
      ...
      >
        <motion.div 
          ...
          className="w-full bg-[#0a0a0a]/90 border-t border-white/10 rounded-t-[32px] overflow-hidden shadow-[0_-10px_40px_rgba(0,0,0,0.8)] max-h-[70vh] flex flex-col"
        >
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                        ...
                        else if (item.id === 'rules') setIsRulesOpen(true);
